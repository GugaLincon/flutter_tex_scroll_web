...
/// A JavaScript interop binding for the `initTeXView` function.
///
...
class TeXRenderingControllerWeb {
  ...
  static void _onWheel(JSNumber deltaY, JSString iframeId) {
    final instance = _instances[iframeId.toDart];
    if (instance != null && instance.mounted) {
      instance.onWheel(deltaY);
    }
  }
}
