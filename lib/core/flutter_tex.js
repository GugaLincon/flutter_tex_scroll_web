...
function initTeXViewMobile(flutterTeXData) {
    ...
    // Add wheel event listener for mobile
    teXViewElement.addEventListener('wheel', function(e) {
...
function initTeXViewWeb(iframeContentWindow, iframeId, flutterTeXData) {
    ...
    // Add wheel event listener for web
    teXViewElement.addEventListener('wheel', function(e) {
        e.preventDefault();
        if (typeof OnWheelCallback !== 'undefined') {
...
function renderCompleted(texViewElement, iframeId, isWeb) {
    ...
    function execute() {
        ...
        if (isWeb) {
            if (typeof OnTeXViewRenderedCallback !== 'undefined') {
...
function clickManager(iframeId, element, id, rippleEffect, isWeb) {
    element.addEventListener('click', function (e) {
        ...
        if (isWeb) {
            if (typeof OnTapCallback !== 'undefined') {
